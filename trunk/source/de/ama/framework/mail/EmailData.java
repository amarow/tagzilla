...
import de.ama.framework.data.StringData;
...
public class EmailData extends Data{
    ...
    public Date   date;
    public int    msgNum;
    public DataTable attachmentsString= new DataTable(new StringData());
    public DataTable   toAdressats  = new DataTable(new AdressatData());
